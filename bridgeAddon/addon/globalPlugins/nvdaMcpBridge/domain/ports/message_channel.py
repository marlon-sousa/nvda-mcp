...
#                 tests/fakes.py FakeChannel (scripted messages).
#
...
# (framing, encoding, the socket) lives behind this port in the adapters.
...
class MessageChannel(ABC):
	...
	def read_message(self) -> dict[str, Any] | Timeout:
		...
		:class:`~...protocol.ValidationError` if a message is unreadable.
		"""
